...
class ServiceTypeFieldMakeAppointMent extends StatelessWidget {
  final SingleValueDropDownController controller;
  const ServiceTypeFieldMakeAppointMent({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: DropDownTextField(
        ...
        validator: (value) {
          if (value == null) {
            return S.of(context).servicetypeerror;
          } else {
            return null;
          }
        },
        ...
        dropDownList: const [
          DropDownValueModel(
            name: "any Thing of Services",
            value: "any Thing of Services",
          ),
          DropDownValueModel(
            name: "other any thing of services",
            value: "other any thing of services",
          ),
        ],
        onChanged: (val) {},
      ),
